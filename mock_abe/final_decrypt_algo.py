...
from .core import MOD, derive_key_bytes, lagrange_reconstruct_zero, xor_bytes
...
def final_decrypt(ciphertext: dict, secret_key: dict, partial: dict) -> dict:
    ...
    recovered_key = derive_key_bytes("H3", ciphertext["C0"], z_exp, length=32)
    tag_check = derive_key_bytes("H4", recovered_key, ciphertext["ciphertext"], z_exp, length=32)
